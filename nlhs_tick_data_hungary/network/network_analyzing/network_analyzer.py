...
class NetworkAnalyzer:
    ...
    def run(self):
        """
        Executes the enabled analysis methods specified in the config dictionary.
    ...
    def calc_largest_connected_component(self) -> int:
        # TODO: ezt nem biztos hogy így kell
        """
